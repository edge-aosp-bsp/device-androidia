...
[groups]
kernel: gmin64(useprebuilt=false, loglevel=7, interactive_governor=false, relative_sleepstates=false, modules_in_bootimg=false, external_modules=,debug_modules=, use_bcmdhd=false, use_iwlwifi=false, extmod_platform=bxt, iwl_defconfig=, more_modules=true, linux_intel_lts2025_src_path=kernel/linux-intel-lts2025, linux_intel_lts2025_cfg_path=config-lts/linux-intel-lts2025)
disk-bus: auto
